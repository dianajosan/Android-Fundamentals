...
public class CountriesAdapter extends RecyclerView.Adapter<CountriesAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView){
            ...
            imageView=itemView.findViewById(R.id.img_london);
            titleTextView=itemView.findViewById(R.id.textview_london);
            favBtn=itemView.findViewById(R.id.fav_button_london);
            ...
            favBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(countriesItem.getFavStatus().equals("0")){
                        ...
                        favDB.insertIntoTheDatabase(countriesItem.getTitle(), countriesItem.getImageResource(),
